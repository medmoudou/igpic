...
//const baseUrlApi = "https://i.instagram.com";
let jar
class Instagram {
  constructor(
  ...
  //https://www.instagram.com/web/likes/2856285360649721656/like/

  //https://i.instagram.com/api/v1/users/web_profile_info/?username=med.moudou
  ...
  async getUser({ username }) {
    ...
    return this.request.get(`/api/v1/users/web_profile_info/?username=${username}`);
